...
let MessageGateway = class MessageGateway {
    ...
    async joinRoom(client, room) {
        ...
        const userId = (_d = (_c = (_b = (_a = client === null || client === void 0 ? void 0 : client.request) === null || _a === void 0 ? void 0 : _a.session) === null || _b === void 0 ? void 0 : _b.passport) === null || _c === void 0 ? void 0 : _c.user) === null || _d === void 0 ? void 0 : _d.id;
        const manager = (0, typeorm_2.getManager)();
        const user = await manager.getRepository(user_entity_1.UserEntity).createQueryBuilder('user')
            .where('user.id = :userId', { userId })
            .getOne();
        if (user.userType === user_entity_1.UserType.STUDENT) {
            const student = await manager.getRepository(student_entity_1.StudentEntity).createQueryBuilder('student')
                ...
                .leftJoinAndSelect('student.team', 'team')
                .getOne();
            if (student === null || student === void 0 ? void 0 : student.team) {
                const teamId = (_e = student === null || student === void 0 ? void 0 : student.team) === null || _e === void 0 ? void 0 : _e.id;
                common_1.Logger.error(`user:${userId} joined the room teamId ${teamId} and room ${userId}`, "MessageGateWay/subscribe(joinTeamRoom)");
                client.join(teamId);
            }
        }
        common_1.Logger.error(`user:${userId} joined the room  ${userId}`, "MessageGateWay/subscribe(joinTeamRoom)");
        client.join(userId);
    }
